...
public final class OpenAiSlideAstClient implements SlideAstClient {
    ...
    private Map<String, Object> requestBody(String prompt) {
        ...
        body.put("input", List.of(
                message("system", """
                        ...
                        Use only these component types: text, bullets, rect, circle, arrow, matrix, table.
                        ...
                        - rect, circle, and arrow components are shapes and should use null for text, items, headers, and rows.
                        Style rules:
                        ...
                        - Use fillColor for rect, circle, matrix, and table backgrounds.
                        - Use strokeColor and strokeWidth for shape outlines, arrows, matrix grid lines, and table grid lines.
    ...
    private static Map<String, Object> deckInputSchema() {
        ...
        Map<String, Object> component = Map.of(
                "anyOf", List.of(
                        componentVariant("text", stringValue, nullSchema(), nullSchema(), nullSchema(), bounds, style),
                        componentVariant("bullets", nullSchema(), stringArray, nullSchema(), nullSchema(), bounds, style),
                        componentVariant("rect", nullSchema(), nullSchema(), nullSchema(), nullSchema(), bounds, style),
                        componentVariant("circle", nullSchema(), nullSchema(), nullSchema(), nullSchema(), bounds, style),
                        componentVariant("arrow", nullSchema(), nullSchema(), nullSchema(), nullSchema(), bounds, style),
                        componentVariant("matrix", nullSchema(), nullSchema(), nullSchema(), stringRows, bounds, style),
                        componentVariant("table", nullSchema(), nullSchema(), stringArray, stringRows, bounds, style)
                )
        );
    ...
    private static Map<String, Object> componentVariant(
        ...
        component.put("required", List.of("id", "type", "text", "items", "headers", "rows", "bounds", "style"));
        component.put("properties", Map.of(
                "id", Map.of("type", "string"),
